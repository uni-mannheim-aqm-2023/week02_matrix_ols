...
Can $\hat{\beta}$ be unbiased and, if not, is there anything we can say about the bias? We simply re-do the proof from earlier:
...
# set a value for delta and simulate data 
delta <- 1
z <- delta*x + e
